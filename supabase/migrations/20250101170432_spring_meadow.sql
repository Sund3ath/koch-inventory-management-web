/*
  # Update licenses table schema
  
  1. Changes
    - Add created_by column to licenses table
    - Update add_license function to properly handle created_by
    - Add RLS policies for created_by
...
GRANT EXECUTE ON FUNCTION add_license TO authenticated;